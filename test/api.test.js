...
before((done) => {
    ...
    const users = [{
        _id: new ObjectId(),
        email: 'sifaoui30yosra@gmail.com',
        token: '7f8c3696-e9bf-327e-8b81-eefdaef510d3'
    }, {
        _id: new ObjectId(),
        email: 'sifaoui30yosra1@gmail.com',
...
describe('POST /api/token', () => {
    ...
    // test 1
    it('get token for sifaoui30yosra@gmail.com', (done) => {

        request(app)
            .post('/api/token')
            .send({ email: 'sifaoui30yosra@gmail.com' })
            .expect(200)
            .expect((res) => {
    ...
    // test 2
    it('should create token for sifaoui30yosra@gmail.com', (done) => {
        ...
        request(app)
            ...
            .end((err, res) => {
                ...
                User.find({ email: 'sifaoui30yosra@gmail.com' }).then((users) => {
    ...
    // test 3
    it('should detect "sifaoui30yosra" is not an email', (done) => {

        request(app)
            .post('/api/token')
            .send({ email: 'sifaoui30yosra' })
            .expect(400)
            .expect((res) => {
